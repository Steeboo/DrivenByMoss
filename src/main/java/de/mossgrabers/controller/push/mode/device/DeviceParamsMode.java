...
public class DeviceParamsMode extends BaseMode
{
    ...
    public void selectNextItemPage() {
        final ICursorDevice cd = this.model.getCursorDevice ();
        if (isShowDevices()){
            final IDeviceBank dbank = cd.getDeviceBank ();
            dbank.selectNextPage();
        } else {
            final IParameterPageBank pbank = cd.getParameterPageBank ();
            pbank.selectNextPage();
        }        
    }
    ...
    public void selectPreviousItemPage() {
        ...
        if (isShowDevices()){
            final IDeviceBank dbank = cd.getDeviceBank ();
            dbank.selectPreviousPage();
        } else {
            final IParameterPageBank pbank = cd.getParameterPageBank ();
            pbank.selectPreviousPage();
        }        
    }
